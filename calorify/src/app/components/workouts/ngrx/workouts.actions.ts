...
import { IExercise, IWorkout } from '../ts/models/workout.model';

export const loadDailyWorkouts = createAction(
    '[Workouts] Load Daily Workouts'
);
...
export const cancelWorkoutsObservables = createAction(
    '[Workouts] Cancel Workouts Observables'
);
